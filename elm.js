   ...
   model) {
      return function () {
         ...
         {case "ChangeColor":
            ...
            case "Draw":
            return function () {
                 var _v9 = $List.head(model.lines);
                 switch (_v9.ctor)
                 {case "Just":
                    return _U.eq(_v9._0.points,
            ...
            case "EndDraw":
            return function () {
                 var _v11 = $List.head(A2($List.map,
                 function (_) {
                    return _.points;
                 },
                 model.lines));
            ...
            switch (_v2._0.ctor)
              {case "_Tuple2":
                 return function () {
                      var _v13 = $List.head(A2($List.map,
                      function (_) {
                         return _.points;
                      },
                      model.lines));
                      ...
                      {case "Just":
                         switch (_v13._0.ctor)
                           {case "::":
                              switch (_v13._0._0.ctor)
                                {case "_Tuple2":
                                   switch (_v13._0._1.ctor)
                                     {case "[]": return model;}
                                     break;}
                                break;}
                           return A2(addLine,
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                                 ...
                                 return function () {
                                    ...
                                    {case "_Tuple2":
                                       return A2($Signal.message,
                                         address,
                                         Draw({ctor: "_Tuple2"
                                              ,_0: _v23._0 - $Basics.toFloat(_v19._0) / 2
                                              ,_1: $Basics.toFloat(_v19._1) / 2 - _v23._1}));}
                                    _U.badCase($moduleName,
                                    "on line 98, column 49 to 115");
                                 }();
                              })
                              ,A3($Html$Events.on,
                              "mousedown",
                              ...
                              function (_v27) {
                                 return function () {
                                    ...
                                    {case "_Tuple2":
                                       return A2($Signal.message,
                                         address,
                                         StartDraw({ctor: "_Tuple2"
                                                   ,_0: _v27._0 - $Basics.toFloat(_v19._0) / 2
                                                   ,_1: $Basics.toFloat(_v19._1) / 2 - _v27._1}));}
                                    _U.badCase($moduleName,
                                    "on line 99, column 49 to 120");
                                 }();
                              })
                 ...
                 _v19._0,
                 _v19._1)($List.map(parseLine)($List.reverse($Debug.watch("lines")(model.lines)))))]));
              }();}
         _U.badCase($moduleName,
