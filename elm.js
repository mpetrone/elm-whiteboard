...
Elm.Board.make = function (_elm) {
   ...
   model) {
      return function () {
         ...
         {case "Change":
            ...
            case "Draw":
            return function () {
                 var _v7 = $List.head(model.lines);
                 switch (_v7.ctor)
                 {case "Just":
                    return _U.eq(_v7._0.points,
   ...
   var buildButton = F2(function (address,
   color) {
      ...
      toColor(color),
      $Graphics$Collage.circle($Basics.toFloat(20)))])))]));
   });
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 var parseLine = function (line) {
                    ...
                    $Graphics$Collage.solid(toColor(line.color)),
                                 ...
                                 return function () {
                                    ...
                                    {case "_Tuple2":
                                       return A2($Signal.message,
                                         address,
                                         Draw({ctor: "_Tuple2"
                                              ,_0: _v21._0 - $Basics.toFloat(_v17._0) / 2
                                              ,_1: $Basics.toFloat(_v17._1) / 2 - _v21._1}));}
                                    _U.badCase($moduleName,
                                    "on line 84, column 49 to 115");
                                 }();
                              })
                              ,A3($Html$Events.on,
                              "mousedown",
                                    ...
                                    {case "_Tuple2":
                                       return A2($Signal.message,
                                         ...
                                         StartDraw({ctor: "_Tuple2"
                                                   ,_0: _v25._0 - $Basics.toFloat(_v17._0) / 2
                                                   ,_1: $Basics.toFloat(_v17._1) / 2 - _v25._1}));}
                                    _U.badCase($moduleName,
                                    "on line 85, column 49 to 120");
                                 }();
                              })
                 ...
                 _v17._0,
                 _v17._1)($List.map(parseLine)($List.reverse($Debug.watch("lines")(model.lines)))))]));
              }();}
         _U.badCase($moduleName,
            ...
            return A2($Html.div,
              ...
              _L.fromArray([A2($Html.div,
                           _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                              ,_0: "position"
                                                                              ,_1: "absolute"}]))]),
                           _L.fromArray([A2(buildButton,
                                        address,
                                        Red)
                                        ,A2(buildButton,address,Green)
                                        ,A2(buildButton,address,Blue)]))
                           ,A3(buildBoard,
                           address,
                           {ctor: "_Tuple2"
                           ,_0: _v29._0
